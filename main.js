        ...
        ev.target.nextElementSibling.querySelector('.add-new-card-btn').addEventListener('click', e => {
          ...
          ev.target.closest('div').previousElementSibling.insertAdjacentHTML('beforeend', `
                        ...
                        <div class="task-tools">
                            <div class="task-tool">
                                <img src="${like_svgrepo_com_namespaceObject}" class="task-tool-img">
                                <span class="task-tool-text">1</span>
                            </div>
                            <div class="task-tool">
                                <img src="${chat_svgrepo_com_namespaceObject}" class="task-tool-img">
                                <span class="task-tool-text">1</span>
                            </div>
                            <div class="task-tool">
                                <img src="${link_svgrepo_com_namespaceObject}" class="task-tool-img">
                                <span class="task-tool-text">1</span>
                            </div>
                            <div class="task-tool">
                                <img src="${selection_box_on_svgrepo_com_namespaceObject}" class="task-tool-img">
                                <span class="task-tool-text">1</span>
                            </div>
                        </div>
                        `);
